...
if dyf_sparkdf.count()!=0:
    ...
    logger.info(f"Renaming existing complain_id column of dynamodb")
...
logger.info(f"Converting spark dataframe into dynamic Dataframe")
newDynamicFrame=DynamicFrame.fromDF(new_sparkdf,glueContext,"new_sparkdf")
logger.info(f"Started writing new records into dynamodb dataframe")
